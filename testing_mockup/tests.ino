...
const full_state_t testStatesInitial[13] = {{10, 7, {2, 2}, 5, 2,7, static_cast<FsmState>(1)}, {9, 1, {0, 0}, 3, 8,10, static_cast<FsmState>(2)}, {8, 1, {2, 2}, 4, 3,2, static_cast<FsmState>(2)}, {5, 3, {2, 2}, 8, 7,7, static_cast<FsmState>(3)}, {6, 5, {2, 2}, 1, 4,3, static_cast<FsmState>(3)}, {50, 7, {1, 1}, 2, 3,5, static_cast<FsmState>(4)}, {3, 8, {0, 0}, 5, 2,1, static_cast<FsmState>(4)}, {100, 100, {1, 2}, 8, 5,9, static_cast<FsmState>(4)}, {2, 1, {2, 2}, 2, 8,10, static_cast<FsmState>(5)}, {10, 10, {2, 2}, 3, 10,2, static_cast<FsmState>(6)}, {1, 6, {2, 2}, 5, 10,6, static_cast<FsmState>(7)}, {9, 2, {1, 2}, 4, 10,5, static_cast<FsmState>(8)}, {1, 3, {2, 2}, 9, 9,2, static_cast<FsmState>(8)}};
const full_state_t testStatesExpected[13] = {{0, 0, {-1, -1}, 1, 4,0, static_cast<FsmState>(2)}, {9, 1500, {1, 1}, 3, 8,10, static_cast<FsmState>(3)}, {8, 1, {2, 2}, 4, 3,2, static_cast<FsmState>(9)}, {5, 3, {2, 2}, 8, 7,7, static_cast<FsmState>(3)}, {150, 5, {2, 2}, 1, 4,3, static_cast<FsmState>(4)}, {50, 7, {1, 1}, 2, 3,6, static_cast<FsmState>(5)}, {3, 8, {0, 0}, 5, 2,0, static_cast<FsmState>(6)}, {100, 100, {1, 2}, 8, 5,9, static_cast<FsmState>(7)}, {2, 1, {2, 2}, 2, 8,10, static_cast<FsmState>(8)}, {10, 10, {2, 2}, 3, 10,2, static_cast<FsmState>(8)}, {1, 6, {2, 2}, 5, 10,6, static_cast<FsmState>(8)}, {9, 2, {1, 2}, 5, 10,5, static_cast<FsmState>(2)}, {1, 3, {2, 2}, 9, 9,2, static_cast<FsmState>(8)}};
const state_inputs_t testInputs[13] = {{4, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 5, 5}, {1, {{{{false, false, false}}, {{false, true, false}}, {{false, false, false}}}}, 3, 100}, {5, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 10, 1}, {3, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 100, 2}, {10, {{{{false, false, false}}, {{false, false, true}}, {{false, false, false}}}}, 0, 150}, {10, {{{{false, false, false}}, {{false, true, false}}, {{false, false, false}}}}, 6, 100}, {5, {{{{false, false, false}}, {{false, true, false}}, {{false, false, false}}}}, 9, 100}, {3, {{{{false, false, false}}, {{false, false, false}}, {{false, false, false}}}}, 1, 300}, {10, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 2, 2}, {2, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 9, 9}, {7, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 3, 4}, {4, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 0, 3}, {9, {{{{false, false, false}}, {{false, false, false}}, {{false, false, true}}}}, 100, 3}};
