...
MCPAccelStepper stepper1(&mcp1, 0, 1, 2, 3);
//MCPAccelStepper stepper2(&mcp1, 4, 5, 6, 7);
MCPAccelStepper stepper2(&mcp1, 8, 9, 10, 11);
MCPAccelStepper stepper3(&mcp1, 12, 13, 14, 15);

//MCPAccelStepper stepper5(&mcp2, 0, 1, 2, 3);
//MCPAccelStepper stepper6(&mcp2, 4, 5, 6, 7);
//MCPAccelStepper stepper7(&mcp2, 8, 9, 10, 11);
//MCPAccelStepper stepper8(&mcp2, 12, 13, 14, 15);

// Regular stepper on Arduino GPIO
//AccelStepper stepper9(AccelStepper::FULL4WIRE, 4, 5, 6, 7);
